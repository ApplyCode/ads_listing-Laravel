...
function bxc_box_installation() { ?>
    <div class="bxc-main bxc-installation bxc-box">
        <form>
            ...
            <div class="bxc-top">
                <img src="http://127.0.0.1:2002/frontend/images/icon/notepad.ico" />
                <div class="bxc-title">
                    Installation
                </div>
                <div class="bxc-text">
    ...
    <div class="bxc-main bxc-login bxc-box">
        <form>
            ...
            <div class="bxc-top">
                ...
                <div class="bxc-text">
                    <?php echo bxc_('To continue to') . ' ' . bxc_settings_get('brand-name', 'Payment') ?>
                </div>
            </div>
...
<head>
    ...
    <title>
        <?php echo BXC_CLOUD && !bxc_verify_admin() ? bxc_settings_get('brand-name', CLOUD_NAME) . ' | Login' : bxc_('Admin') . ' | ' . (BXC_CLOUD ? CLOUD_NAME : bxc_settings_get('brand-name', 'Payment')); ?>
    </title>
