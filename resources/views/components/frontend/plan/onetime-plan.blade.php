...
<div class="container">
    ...
    {{-- Bitcoin Form --}}
    <form action="{{ route('bitcoin.post',$plan->id) }}" method="POST" class="hidden" id="bitcoin-form">
        @csrf
    </form>
...
@push('js')
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            $('#bitcoin_btn').on('click', function (e) {
                e.preventDefault();
                $('#bitcoin-form').submit();
            });
