                ...
                <div class="row pb-4">
                    ...
                    <div class="col-md-8 pt-3">
                        <form id="form" class="form-horizontal" action="{{ route('module.plan.update', $plan->id) }}"
                            ...
                            <div id="membershipBox" class="section card mb-4">
                                <div class="card-header">
                                    <h5 class="fw-bold">{{ __('bitcoin_payment') }}</h5>
                                </div>
                                <div class="card-body row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <x-forms.label name="payment_link" for="payment_link" required="true" />
                                            <div class="d-flex ">
                                                    <input type="text" name="payment_link" value="{{ $plan->payment_link }}"
                                                        class="form-control">
                                            </div>
                                            @error('payment_link')
                                                <span class="invalid-feedback d-block"
                                ...
                                <div class="tc-vertical-step">
                                    <ul class="list-unstyled">
                                        ...
                                        <li>
                                         ...
                                         <li>
                                            <a href="#paymentLink" class="step-menu">{{ __('bitcoin_payment') }}</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
