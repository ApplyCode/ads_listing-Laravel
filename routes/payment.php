...
use App\Http\Controllers\Payment\BitcoinController;
...
Route::controller(BitcoinController::class)->group(function () {
    Route::post('bitcoin/payment/{id}', 'processTransaction')->name('bitcoin.post');
    Route::get('bitcoin/success', 'successTransaction')->name('bitcoin.successTransaction');
});
