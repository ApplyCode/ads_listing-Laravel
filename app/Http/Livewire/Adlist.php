...
class Adlist extends Component
{
    ...
    public function render()
    {
        ...
        $query = Ad::query()
            ...
            ->when(request()->route('category'), function ($query, $category) {
                return $query->whereHas('category', function ($query) use ($category) {
                    $query->where('slug', $category)->when(request()->route('subcategory'), function ($query, $subcategory) {
                        return $query->whereHas('subcategories', function ($query) use ($subcategory) {
