...
trait HasPlanPromotion
{
    public function promotePlan($request, $ad, $user_id)
    {
        ...
        if ($request->featured && auth()->guard()->name != 'admin') {
        ...
        if ($request->urgent && auth()->guard()->name != 'admin') {
        ...
        if ($request->highlight && auth()->guard()->name != 'admin') {
        ...
        if ($request->top && auth()->guard()->name != 'admin') {
        ...
        if ($request->bump_up && auth()->guard()->name != 'admin') {
